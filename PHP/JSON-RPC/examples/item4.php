<?php
$item4save['item_id']=4;
$item4save['option_id']=44;

$item4save['rr_price'] = 6;
$item4save['price_old'] = 7;
$item4save['price'] = 8;

$item4save["group_prices"] = [
...
//==> specifications
$item4save['specifications']['base_curve'] = 1;
$item4save['specifications']['sph_min'] = 2;
$item4save['specifications']['sph_max'] = 3;
$item4save['specifications']['sph_step'] = 4;
$item4save['specifications']['cyl'] = 'cyl';
$item4save['specifications']['axis'] = 'axis';
$item4save['specifications']['multifocaladd'] = 'multifocaladd';
$item4save['specifications']['warranty_period'] = 5;
$item4save['specifications']['pd'] = 6;
$item4save['specifications']['height'] = 7;
$item4save['specifications']['width'] = 8;
$item4save['specifications']['depth'] = 9;
$item4save['specifications']['weight'] = 10;
$item4save['specifications']['frame_sizes'] = [
    "arm" => 1,
    "bridge" => 1,
    "lens" => 1,
    "height" => 1,
...
//==> stock
$item4save['stock']['is_out_of_stock'] = true;
$item4save['stock']['featured'] = false;
$item4save['stock']['discontinued'] = true;


$item4save['colours'] = ["red", "blue", "white"];
...
$item4save['migration']['item_added'] = '2015-08-09T01:02:03.456Z';
...
$item4save['migration']['is_modified'] = true;
...
$item4save['options']['option_order'] = 1;