<pre>
<?php
include(dirname(__FILE__) . '/SelectSpecs_v_0_3/include.php');
...
"api.warder.tk", 9984, "SeCrEtToKeNvAlUe", "GrOuPiD"

$ssapi = new SSAPI("api.warder.tk", 9984, "SeCrEtToKeNvAlUe", "GrOuPiD"); //if we dont send params all params will loaded from config.php file
